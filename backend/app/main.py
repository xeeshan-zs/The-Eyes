...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://z-eyes.web.app",
        "https://z-eyes.firebaseapp.com",
        "http://localhost:5173",
        "http://127.0.0.1:5173",
        "http://localhost:3000",
    ],
    allow_origin_regex=r"https://.*\.web\.app|https://.*\.firebaseapp\.com|https://.*\.onrender\.com|http://localhost:\d+|http://127\.0\.0\.1:\d+",
